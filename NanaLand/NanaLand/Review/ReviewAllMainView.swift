                                    ...
                                    VStack(alignment: .leading, spacing: 0) {
                                        HStack(spacing: 0) {
                                            ...
                                            HStack(spacing: 0) {
                                                ...
                                                Button {
                                                    Task{
                                                        await reviewFavorite(id: viewModel.state.getReviewAllMainResponse.data![index].id)
                                                    }
                                                } label: {
                                                    Image(viewModel.state.getReviewAllMainResponse.data![Int(index)].reviewHeart ? "icReviewHeartMain" : "icReviewHeart")
                                                        .resizable()
                                            ...
                                            .overlay(
                                                       RoundedRectangle(cornerRadius: 30) // 모서리가 둥근 테두리
                                                        .stroke(viewModel.state.getReviewAllMainResponse.data![Int(index)].reviewHeart ? Color.main : Color.gray2 , lineWidth: 1) // 테두리 색상과 두께
                                                   )
                                            .padding(.top, 16)
                                            .padding(.trailing, 16)
