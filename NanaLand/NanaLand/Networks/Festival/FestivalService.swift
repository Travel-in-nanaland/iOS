...
struct FestivalService {
    static func getThisMonthFestivalMainItem(page: Int32, size: Int32, filterName: String, startDate: String, endDate: String) async -> BaseResponse<FestivalModel>? {
    ...
    static func getSeasonFestivalMainItem(page: Int32, size: Int32, season: String) async -> BaseResponse<FestivalModel>? {
        return await NetworkManager.shared.request(FestivalEndPoint.seasonFestival(page: page, size: size, season: season))
    }
    
    static func getPastFestivalMainItem(page: Int32, size: Int32, filterName: String) async -> BaseResponse<FestivalModel>? {
