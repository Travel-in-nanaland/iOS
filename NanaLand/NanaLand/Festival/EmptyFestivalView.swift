...
struct EmptyFestivalView: View {
    var content: String = ""
    @Binding var location: String
    @Binding var yearMonthDay: YearMonthDay?
    @Binding var season: String
    @Binding var calendarModal: Bool
    @Binding var seasonModal: Bool
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 4) {
            ...
            if content == "이번달" {
                Text(.emptyFestivalThisMonth)
                    .font(.body01)
                    .foregroundColor(.gray1)
                    .frame(height: Constants.screenWidth * (26 / 360))
                    .multilineTextAlignment(.center)
                
                Text(.emptyFestivalThisMonthSub)
                    .font(.body02)
                ...
                Button(action: {
                    ...
                    Text(.emptyFestivalThisMonthButton)
                ...
                Button(action: {
                    ...
                    Text(.emptyFestivalSeasonButton)
                        .font(.body02_semibold)
                        .foregroundColor(.gray1)
                        .frame(height: Constants.screenWidth * (22 / 360))
                        .padding(EdgeInsets(top: Constants.screenWidth * (9 / 360), leading: Constants.screenWidth * (28 / 360), bottom: Constants.screenWidth * (9 / 360), trailing: Constants.screenWidth * (28 / 360)))
...
#Preview {
    EmptyFestivalView(location: .constant(""), yearMonthDay:
            .constant(nil), season: .constant(""), calendarModal: .constant(false), seasonModal: .constant(false))
}
