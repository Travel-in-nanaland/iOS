...
#Preview {
    ArticleItem(category: .experience, article: Article(id: 0, firstImage: ArticleImageList(originUrl: "http://tong.visitkorea.or.kr/cms/resource/85/3076985_image3_1.jpg", thumbnailUrl: "http://tong.visitkorea.or.kr/cms/resource/85/3076985_image3_1.jpg"), title: "근하신뇽! 새해도 9.81파크와 함께해용", favorite: true, category: .experience, onGoing: false), onTapHeart: {})
}
